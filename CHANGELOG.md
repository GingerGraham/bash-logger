...
## [2.6.0](https://github.com/GingerGraham/bash-logger/compare/2.5.6...2.6.0) (2026-09-22)

### Features

* **ci:** add manual bump control and workbench.yml release detection ([#130](https://github.com/GingerGraham/bash-logger/issues/130))
...
* **#120:** ensure message handling in journal logging command ([#121](https://github.com/GingerGraham/bash-logger/issues/121))
